...
**🟢 Status: live on mainnet.** The strategy has been iterated through multiple real trading cycles with a documented bug-fix history, and the tradable-asset whitelist has been expanded from an initial 21 to 67 pairs after live verification of leverage/liquidity on both venues.
